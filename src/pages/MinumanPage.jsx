    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-cyan-50 pb-20 md:pb-8">
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        <div className="mb-8 md:mb-12 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4">Temukan Resep Minuman Segarmu</h1>
          <div className="max-w-2xl mx-auto">
            <input
              type="text"
              className="w-full px-5 py-3 text-lg border-2 border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              placeholder="Ketik nama minuman, contoh: Es Teler..."
              value={searchQuery}
